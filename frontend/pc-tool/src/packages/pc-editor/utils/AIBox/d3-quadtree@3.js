...
function init(t) {
    ...
    function i(t, i, e, n) {
        ...
        for (; c.length; )
            if (
                ...
                return (r[_] = x), t;
        if (((o = +t._x.call(null, c.data)), (a = +t._y.call(null, c.data)), i === o && e === a))
    ...
    function o(t) {
        for (var i = { data: t.data }, e = i; (t = t.next); ) e = e.next = { data: t.data };
        return i;
    }
    ...
    (a.copy = function () {
        ...
        (a.cover = function (t, i) {
            ...
            if (isNaN(e)) (r = (e = Math.floor(t)) + 1), (s = (n = Math.floor(i)) + 1);
                ...
                for (var h, o, a = r - e || 1, u = this._root; e > t || t >= r || n > i || i >= s; )
                    switch (
                        ((o = ((i < n) << 1) | (t < e)),
                        ((h = new Array(4))[o] = u),
                        (u = h),
        ...
        (a.remove = function (t) {
            if (isNaN((s = +this._x.call(null, t))) || isNaN((h = +this._y.call(null, t))))
                return this;
            var i,
                e,
                n,
        ...
        (a.visitAfter = function (t) {
            var i,
                ...
                r = [];
            for (
                this._root && n.push(new e(this._root, this._x0, this._y0, this._x1, this._y1));
                (i = n.pop());
