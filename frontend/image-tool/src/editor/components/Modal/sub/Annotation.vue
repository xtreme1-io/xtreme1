...
// const options = [
//     { label: '漏标', value: 'result_empty' },
//     { label: '错标', value: 'result_error' },
//     { label: '标签错误', value: 'lable_error' },
//     { label: '不贴合', value: 'not_fit' },
//     { label: '多标', value: 'more_error' },
//     { label: '其他', value: 'other' },
// ];

const rules = {
    checked: [{ type: 'array', required: true, message: '至少选择一个', trigger: 'change' }],
};
