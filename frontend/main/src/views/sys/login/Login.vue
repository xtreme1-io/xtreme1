<template>
  <div :class="prefixCls">
    <div class="content">
      ...
      <div class="info">
        <span class="link cursor-pointer" @click="handleGoPortal">BasicAI</span> Xtreme1
        is an open-source platform optimizing your data labeling and accelerating AI and
